...
const CARD_LIBRARY_SCRIPT := preload("res://scripts/card_library.gd")
...
const PLAYER_AVATAR_TEXTURE := preload("res://assets/characters/luna.png")
const MONSTER_AVATAR_TEXTURE := preload("res://assets/characters/demon-hall.png")
const CARD_ART_DIRECTORY := "res://assets/card_art"
...
var card_library: CardLibrary = CARD_LIBRARY_SCRIPT.new(
	CARDS_DATA_PATH,
	STARTING_DECK_DATA_PATH,
	CARD_ART_DIRECTORY,
	CARD_ART_EXTENSIONS
)
...
func _start_battle() -> void:
	...
	combat_state.set_starting_deck(card_library.build_starting_deck())
